    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div id="main-container" class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div>
                    <h2 class="mb-4">Instrumentos</h2>
                    <div>
                        <a href="{{ route('instruments.create') }}" class="btn btn-custom">Nuevo</a>
                    </div>
                    <br>
                    <div>
                        <table id="instruments-table" class="table table-bordered data-table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre</th>
    ...
    <script>
        $(document).ready(function() {
            $('#instruments-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.instruments.datatables') }}",
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'name', name: 'name' },
